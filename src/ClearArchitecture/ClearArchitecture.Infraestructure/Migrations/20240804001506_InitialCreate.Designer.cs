...
namespace ClearArchitecture.Infraestructure.Migrations
{
    ...
    [Migration("20240804001506_InitialCreate")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("ClearArchitecture.Domain.Alquileres.Alquiler", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid")
            ...
            modelBuilder.Entity("ClearArchitecture.Domain.Reviews.Review", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid")
            ...
            modelBuilder.Entity("ClearArchitecture.Domain.Users.User", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid")
            ...
            modelBuilder.Entity("ClearArchitecture.Domain.Vehiculos.Vehiculo", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid")
            ...
            modelBuilder.Entity("ClearArchitecture.Domain.Alquileres.Alquiler", b =>
                {
                    b.HasOne("ClearArchitecture.Domain.Users.User", null)
                        .WithMany()
                    ...
                    b.HasOne("ClearArchitecture.Domain.Vehiculos.Vehiculo", null)
                        .WithMany()
                    ...
                    b.OwnsOne("ClearArchitecture.Domain.Shared.Moneda", "Accesorios", b1 =>
                        {
                    ...
                    b.OwnsOne("ClearArchitecture.Domain.Shared.Moneda", "Mantenimiento", b1 =>
                        {
                            b1.Property<Guid>("AlquilerId")
                                .HasColumnType("uuid")
                                .HasColumnName("id");
                    ...
                    b.OwnsOne("ClearArchitecture.Domain.Shared.Moneda", "PrecioPorPeriodo", b1 =>
                        {
                            b1.Property<Guid>("AlquilerId")
                                .HasColumnType("uuid")
                                .HasColumnName("id");
                    ...
                    b.OwnsOne("ClearArchitecture.Domain.Shared.Moneda", "PrecioTotal", b1 =>
                        {
                            b1.Property<Guid>("AlquilerId")
                                .HasColumnType("uuid")
                                .HasColumnName("id");
                    ...
                    b.OwnsOne("ClearArchitecture.Domain.Alquileres.DateRange", "Duracion", b1 =>
                        {
                            b1.Property<Guid>("AlquilerId")
                                .HasColumnType("uuid")
                                .HasColumnName("id");
            ...
            modelBuilder.Entity("ClearArchitecture.Domain.Reviews.Review", b =>
                {
                    b.HasOne("ClearArchitecture.Domain.Alquileres.Alquiler", null)
                        .WithMany()
                        .HasForeignKey("AlquilerId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired()
            ...
            modelBuilder.Entity("ClearArchitecture.Domain.Vehiculos.Vehiculo", b =>
                {
                    b.OwnsOne("ClearArchitecture.Domain.Vehiculos.Direccion", "Direccion", b1 =>
                        {
                    ...
                    b.OwnsOne("ClearArchitecture.Domain.Shared.Moneda", "Precio", b1 =>
                        {
                            b1.Property<Guid>("VehiculoId")
                                .HasColumnType("uuid")
                                .HasColumnName("id");
